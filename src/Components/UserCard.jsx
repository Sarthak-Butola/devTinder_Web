  ...
  return (
    user && (
      <div className={`transition-all duration-500 ease-in-out transform ${animationClass}`}>
        <div className="px-4"> {/* Outer horizontal padding for mobile */}
          <div
            className={`max-w-md w-full mx-auto my-6 rounded-2xl overflow-hidden border border-gray-600 duration-500 ${
              mode
